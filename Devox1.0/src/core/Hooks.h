...
namespace hooks {
	...
	using function_mouse_input_enabled = bool(__thiscall*)(sdk::interface_cs2_input*);
	inline function_mouse_input_enabled original_mouse_input_enabled = nullptr;

	using function_set_relative_mouse_mode = void*(__thiscall*)(sdk::interface_input_rendszer*, bool);
